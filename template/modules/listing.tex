...
\newcommand{\lstfile}[4][\mylstlanguage]{
  \ifthenelse{\boolean{myLstFrame}}{
    \lstinputlisting[language=#1,caption={#3},label={lst:#4},frame=single]{#2}
  }{
    \lstinputlisting[language=#1,caption={#3},label={lst:#4},frame=none]{#2}
  }
}
