...
\newboolean{myaddlistofabbreviationsBoolean}
\setboolean{myaddlistofabbreviationsBoolean}{\myaddlistofabbreviations}
%%%%%%%%%%%%%%
% document
\begin{document}
...
% abbreviations
\ifthenelse{\boolean{myaddlistofabbreviationsBoolean}}{
	\include{document/other/abbreviations}
}{}
