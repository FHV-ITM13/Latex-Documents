...
% attatchment
\newboolean{myAddAttachment}
\setboolean{myAddAttachment}{\myaddattachment}
% references list
\newboolean{myAddStatutoryDeclaration}
\setboolean{myAddStatutoryDeclaration}{\myaddstatutorydeclaration}
...
% attachment
\ifthenelse{\boolean{myAddAttachment}}{
	\input{document/other/attachment}
}{}

% statutory declaration
\ifthenelse{\boolean{myAddStatutoryDeclaration}}{
