...
Um ein Abkürzungsverzeichnis zu erstellen, bietet sich das acronym-Paket an.
Dokumentation der Packages (PDF, englisch):

	\begin{itemize}
		\item \url{ftp://ftp.tu-chemnitz.de/pub/tex/macros/latex/contrib/acronym/acronym.pdf}
		\item \url{http://de.wikibooks.org/wiki/LaTeX-W%C3%B6rterbuch:_Abk%C3%BCrzungsverzeichnis}
	\end{itemize}
